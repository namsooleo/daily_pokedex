...
def is_first_run():
    ...
    if not os.path.isfile('/home/codestrife00/scripts/daily_pokedex/PokeData.csv'):     # FIXME: Change dir to a variable
    ...
    # If the PokeData.csv already exists just import it
        ...
        df = pd.read_csv('/home/codestrife00/scripts/daily_pokedex/PokeData.csv', index_col='ID')  # FIXME: Change dir to a variable
    return df
...
def get_sprite(sprite_url): 
    ...
    filepath = f'/home/codestrife00/scripts/daily_pokedex/sprites/{filename}' # FIXME: Change dir to a variable
...
def export_df(df):
    ...
    try:
        df.to_csv('/home/codestrife00/scripts/daily_pokedex/PokeData.csv') # FIXME: Change dir to a variable
        return 0
    except:
        return 1
